      ...
      <div class="col-md-4"> <br>
        <div class="form-group">
          ...
          <form action="update.php" method="POST" align="center">
            ...
            <input type="number" name="Customer_ID" class="form-control" required value="<?php echo $result['Customer_ID']; ?>">

            <label for="name" class="col-sm-2 col-form-label"> วันเวลา: </label>

            <input type="datetime-local" name="Order_Date_Time" class="form-control" required value="<?php echo $result['Order_Date_Time']; ?>">

            <label for="name" class="col-sm-2 col-form-label"> รหัสติดตามพัสดุ: </label>

            <input type="number" name="Track_ID" class="form-control" required value="<?php echo $result['Track_ID']; ?>">
