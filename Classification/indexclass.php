    ...
    <aside>
        <aside class="sidebar">
            ...
            <ul class="links">
                ...
                <li>
                    <span class="material-symbols-outlined">table_view</span>
                    <a href="indexclass.php">classification</a>
                </li>
                <li>
                    ...
                    <div class="col-md-12"> <br>
                        ...
                        <table id="ITTable" class="display-table table-dark table-striped table-responsive table-bordered table table-hover vw-50 vh-50" data-component="datatable" data-locale="en" data-search="true">
                            ...
                            <tbody align="center">
                                ...
                                foreach ($result as $r) { ?>
                                    <tr>
                                        <td><?= $r['Classification_ID'] ?></td>
                                        <td><?= $r['Classification_Name'] ?></td>
                                        <td><a href="updateform.php?Classification_ID=<?= $r['Classification_ID'] ?>&Classification_Name=<?= $r['Classification_Name'] ?>" class="btn btn-warning btn-sm">แก้ไข</a></td>
                                        <td><a href="delete.php?Classification_ID=<?= $r['Classification_ID'] ?>Classification_Name=<?= $r['Classification_Name'] ?>" class="btn btn-danger btn-sm " data-toggle="modal" data-target="#ModalCenter" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a></td>
                                    </tr>
                                <?php }
                                ?>
                            </tbody>
